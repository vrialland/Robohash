...
""",
        ...
        drquotes = [
            ...
            (
                "Superior technology and overwhelming brilliance.",
                "Dr. Thomas Light, Paid Testimonial",
            ),
            ...
            (
                "To make any alteration would prove fatal.",
                "Dr. Eldon Tyrell, MindHacker.com",
            ),
            ("The robots are all so.. Normal!", "Joanna Eberhart, Beta tester"),
            (
                "Man shouldn't know where their robots come from.",
        ...
        avatarquotes = [
            ("I'm just here to fix the robots."),
    ...
    def get(self, string=None):
        ...
        if args.get("gravatar", "").lower() == "yes":
            ...
            gravatar_url = (
                ...
                + hashlib.md5(string.lower()).hexdigest()
                + "?"
            )
...
def main():
    ...
    print(
        "The Oven is warmed up - Time to make some Robots! Listening on port: "
        + str(options.port)
    )
